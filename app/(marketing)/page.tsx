...
const PROJECTS = [
  { name: 'CaissePro', subFr: "Caisse & Gestion d'entreprise", subEn: 'POS & Business Management', descFr: "Système de caisse moderne pour commerçants africains. Inventaire, reçus WhatsApp, Wave/Orange Money, support CFA.", descEn: 'Modern POS for African merchants. Inventory, WhatsApp receipts, Wave/Orange Money, CFA support.', logo: '/logo-caissepro.png', logoBg: '#fff', color: 'linear-gradient(135deg,#0d1f4a,#1a3a8f)', tags: ['Next.js','Supabase','PWA','Wave API'] },
  { name: 'VYBZ Social', subFr: 'Plateforme Sociale — Dakar', subEn: 'Social Platform — Dakar', descFr: '"C\'est quoi les VYBZ ce soir ?" — Événements, vie nocturne et expériences à Dakar et dans la diaspora africaine.', descEn: '"What are the VYBZ tonight?" — Events, nightlife & experiences connecting Dakar and the African diaspora.', logo: '/logo-vybz.png', logoBg: '#0a0010', color: 'linear-gradient(135deg,#150020,#3d0060)', tags: ['React Native','Firebase','Maps'] },
  { name: 'Mon Livreur', subFr: 'Livraison & Logistique', subEn: 'Delivery & Logistics', descFr: '"Livrer plus vite, plus loin, pour vous." Livraison en temps réel pour les entreprises africaines.', descEn: '"Deliver faster, further, for you." Real-time delivery & logistics for African businesses.', logo: '/logo-monlivreur.png', logoBg: '#fff', color: 'linear-gradient(135deg,#0d2a1a,#1a6e3a)', tags: ['React Native','Node.js','Maps API'] },
]
