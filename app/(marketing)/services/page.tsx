...
const SERVICES = [
  { icon: '📱', label: 'Mobile App Development', color: '#60a5fa', desc: 'Native and cross-platform Android & iOS apps built for African consumers. Fast, offline-capable, and beautifully designed.', benefits: ['Android & iOS', 'Offline-first capability', 'Mobile money integration', 'WhatsApp notifications', 'French/Wolof/English UI'] },
  { icon: '🌐', label: 'Website Development', color: '#00c8ff', desc: 'Modern, fast, responsive websites that convert visitors into customers. From landing pages to full enterprise web platforms.', benefits: ['SEO-optimized', 'Mobile-first design', 'Fast loading on 2G/3G', 'CMS-powered', 'African market focus'] },
  { icon: '🏪', label: 'POS & Business Software', color: '#00e676', desc: 'Point-of-sale systems powered by CaissePro. Wave, Orange Money, Free Money — all integrated natively for African merchants.', benefits: ['Wave & Orange Money', 'Inventory management', 'WhatsApp receipts', 'Customer debt tracking', 'Daily reports & analytics'] },
  { icon: '☁️', label: 'SaaS Platforms', color: '#a78bfa', desc: 'Full multi-tenant SaaS platforms built to scale across Africa. We handle architecture, security, and scalability.', benefits: ['Multi-tenant architecture', 'Subscription billing', 'Supabase & Next.js', 'Role-based access', 'API-first design'] },
  { icon: '🛒', label: 'E-Commerce Solutions', color: '#fbbf24', desc: 'Complete online stores with African payment gateways, WhatsApp ordering, and multilingual support for African markets.', benefits: ['CinetPay & PayDunya', 'WhatsApp ordering', 'Product catalog', 'Order management', 'Multi-language'] },
  { icon: '⚡', label: 'Automation Systems', color: '#f97316', desc: 'Automate repetitive business tasks, notifications, reports, and workflows to save time and scale efficiently.', benefits: ['WhatsApp automation', 'Report automation', 'Stock alerts', 'Payment reminders', 'Custom workflows'] },
  { icon: '🎨', label: 'Branding & Marketing', color: '#ec4899', desc: 'Professional brand identity, social media management, and digital marketing campaigns that grow your audience.', benefits: ['Logo & brand identity', 'Social media content', 'Digital ads', 'Content strategy', 'Growth consulting'] },
  { icon: '🤖', label: 'AI Integrations', color: '#c77dff', desc: 'Smart AI tools integrated into your business — chatbots, analytics, personalization engines, and voice assistants.', benefits: ['AI chatbots', 'Smart analytics', 'Product recommendations', 'Customer support AI', 'French & Wolof NLP'] },
]
          ...
          {SERVICES.map((s, i) => (
            <div key={i} style={{ background: 'rgba(13,20,37,0.7)', border: '1px solid rgba(30,45,74,0.5)', borderRadius: 20, padding: 32, backdropFilter: 'blur(10px)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 20 }}>
                <div style={{ width: 52, height: 52, background: `${s.color}15`, border: `1px solid ${s.color}33`, borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>{s.icon}</div>
